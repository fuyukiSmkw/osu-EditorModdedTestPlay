...
:: ===== Configuration =====
set "RULESET_URL=https://github.com/fuyukiSmkw/osu-EditorModdedTestPlay/releases/latest/download/osu.Game.Rulesets.EditorModdedTestPlay.dll"
set "RULESET_NAME=osu.Game.Rulesets.EditorModdedTestPlay.dll"

echo.
echo ============================================
echo osu.Game.Rulesets.EditorModdedTestPlay.dll Ruleset Installer
echo   from https://github.com/fuyukiSmkw/osu-EditorModdedTestPlay
echo ============================================
echo.
