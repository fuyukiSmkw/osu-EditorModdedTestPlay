...
# ===== Configuration =====
RULESET_URL="https://github.com/fuyukiSmkw/osu-EditorModdedTestPlay/releases/latest/download/osu.Game.Rulesets.EditorModdedTestPlay.dll"
RULESET_NAME="osu.Game.Rulesets.EditorModdedTestPlay.dll"
