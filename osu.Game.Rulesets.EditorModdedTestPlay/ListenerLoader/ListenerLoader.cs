...
using osu.Game.Rulesets.EditorModdedTestPlay.ListenerLoader.Handlers;

#nullable enable

namespace osu.Game.Rulesets.EditorModdedTestPlay.ListenerLoader;
...
public partial class ListenerLoader : AbstractHandler
{
    ...
    private static AbstractHandler[] injectors()
    {
        return
        [
            new EditorModdedTestPlayRulesetIconListener(),
    ...
    public bool BeginInject(Storage storage, OsuGame? gameInstance, Scheduler scheduler)
    {
        ...
        {
            // Add Resource store
            gameInstance.Resources.AddStore(new DllResourceStore(typeof(EditorModdedTestPlayRuleset).Assembly));
